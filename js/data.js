export const HOTSPOTS_DATA = [
  ...
  { id: 'nucleus', title: 'Nucleus', desc: 'The command center of the cell. It acts like a vault, safely storing all of your DNA.', pos: [-2.8, 1.4, -3.5], color: 0x4ecdc4, type: 'nucleus' },
  ...
  { id: 'lungs', title: 'Lungs', desc: 'A pair of spongy, air-filled organs. They bring oxygen into the bloodstream and remove carbon dioxide.', pos: [1.2, 1.4, -11.5], color: 0xfca5a5, type: 'lungs', model: 'models/lungs.glb', modelScale: 0.4 },
